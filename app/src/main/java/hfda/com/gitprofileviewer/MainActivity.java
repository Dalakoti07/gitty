...
//                            Toast.makeText(MainActivity.this, "Line 56", Toast.LENGTH_SHORT).show();
                        try {
...
//                                tvResult.append(temp.getString("login")+"\n");
        ...
        queue.add(request);
        Toast.makeText(this, Integer.toString(githubUsers.size()), Toast.LENGTH_SHORT).show();
        for(int i=0;i<githubUsers.size();i++){
//            System.out.println(githubUsers.get(i));
